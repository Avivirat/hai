...
namespace Valuelabs.API.Data
{
    public class ChatingRepository : IChatingRepository
    {
        ...
        public async Task<IEnumerable<Message>> GetMessageThread(int userId, int recipientId)
        {
            ...
            .Include(u => u.Recipient).ThenInclude(p => p.Photos).Where(m => m.RecipientId == userId && m.RecipientDeleted == false && m.SenderId == recipientId || m.RecipientId == recipientId && m.SenderId == userId && m.SenderDeleted == false)
